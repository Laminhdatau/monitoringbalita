<center>
    <div class="container-fluid">
        ...
        <!-- <div class="text-center align-items-center justify-content-between mb-4" style="background: linear-gradient(to bottom, #6600cc 0%, #6600cc 100%);">
            <h1 style="margin-top: 4% ;" class="text-bold text-black h3 mb-3 text-gray-8000 m-0 font-weight-bold text-gray-100">
                <marquee behavior="" direction="">Pantau Pertumbuhan Anak Anda</marquee>
            </h1>
    ...
    <div class="card shadow mb-4 border-left-secondary">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><div class="text-center align-items-center justify-content-between mb-0" >
            <h1 style="margin-top: 4% ;" class="text-bold text-black h3 mb-0 text-gray-8000 m-0 font-weight-bold text-gray-100">
                <marquee behavior="" direction="">Pantau Pertumbuhan Anak Anda</marquee>
            </h1>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr style="background-color: dodgerblue;" class="m-0 font-weight-bold text-gray-100 text-center align-items-center">
                            <th>No</th>
                            <th>Nik</th>
                            <th>Nama</th>
                            <th>Tanggal Lahir</th>
